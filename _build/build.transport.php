...
define('PKG_NAME','Glossary');
define('PKG_NAME_LOWER','glossary');
...
## Package GlossaryHighlighter plugin ######################################################
include $sources['data'].'transport.plugin.GlossaryHighlighter.php';
